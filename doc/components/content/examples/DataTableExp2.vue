<template>
  <div>
    <div class="flex flex-col justify-between gap-5 md:flex-row md:items-center">
      <WInput type="search" v-model="search" placeholder="Search" class="w-full md:w-96" />
      <w-dropdown-menu>
        ...
        <WDropdownMenuContent :side-offset="10" align="start" class="w-[300px] md:w-[200px]">
    ...
    >
      <template #empty>
        <div class="flex w-full flex-col items-center justify-center gap-5 py-5">
          <svg class="w-12 he-12 text-muted-foreground" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" ><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M3 5V19A9 3 0 0 0 21 19V5"/><path d="M3 12A9 3 0 0 0 21 12"/></svg>
