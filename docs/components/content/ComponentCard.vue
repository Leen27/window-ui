...
const name = props.slug || `W${upperFirst(camelCase(route.params.slug[route.params.slug.length - 1]))}`
...
<template>
  <div>
    ...
    <!-- <ContentRenderer :value="ast" class="[&>div>pre]:!rounded-t-none [&>div>pre]:!mt-0" /> -->
  </div>
</template>
